...
const InteractionInsights = ({ companies, theme, interactions }) => {
    //   Set the heueristics for insights as appropriate, we may want to consider moving them to an external file
    const averageInteractionsStandard = 10;
    const totalCompanies = companies.length;
    ...
    return (
        <Box className={styles.container}>
            <Box className={styles.statsContainer}>
                ...
                <StatBox
                    icon={avgIcon}
                    statistic={`${avgInteractionsPerCompany} of ${averageInteractionsStandard}`}
            ...
            <Box className={styles.contentContainer}>
                <PieChart
                    items={interactions}
                    itemKey='interaction_type'
                    itemType='Interaction type'
